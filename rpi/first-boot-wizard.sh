...
echo -e "${GRAY} . · . · . · . · . · . · . · . · . · . · . · . · . · . · . · . · .${NC}"
echo -e "${GRAY} · . · . · . · . · . · . · . · . · . · . · . · . · . · . · . · . ·${NC}"
echo -e "${GRAY} . · . · . · . · . · .${NC} ${CYAN}/\\${NC} ${GRAY}· . ·${NC} ${CYAN}/\\${NC} ${GRAY}· . ·${NC} ${CYAN}/\\${NC} ${GRAY}· . ·${NC} ${CYAN}/\\${NC} ${GRAY}· . · . · . .${NC}"
echo -e "${GRAY} · . · . · . · . · . ·${NC} ${CYAN}\\/${NC} ${GRAY}· . ·${NC} ${CYAN}\\/${NC} ${GRAY}· . ·${NC} ${CYAN}\\/${NC} ${GRAY}· . ·${NC} ${CYAN}\\/${NC} ${GRAY}· . · . · . ·${NC}"
echo -e "${GRAY} . · . · . · . · . · . · . · . · . · . · . · . · . · . · . · . · .${NC}"
echo -e "${GRAY} · .${NC}  ${CYAN} ___  _____  ___    ___    _    ___    ___    ___${NC}   ${GRAY}· . · ·${NC}"
echo -e "${GRAY} . ·${NC}  ${CYAN}/ __||_   _|| __|  / __|  /_\\  / __|  / _ \\  / _ \\${NC}  ${GRAY}. · . ·${NC}"
echo -e "${GRAY} · .${NC}  ${CYAN}/ __||_   _|| __|  / __|  /_\\  / __|  / _ \\  / _ \\${NC}  ${GRAY}· . · ·${NC}"
echo -e "${GRAY} . ·${NC}  ${CYAN}\\__ \\  | |  | _|  | (_ | / _ \\ \\__ \\ | (_) || (_) |${NC} ${GRAY}. · . ·${NC}"
echo -e "${GRAY} · .${NC}  ${CYAN}\\__ \\  | |  | _|  | (_ | / _ \\ \\__ \\ | (_) || (_) |${NC} ${GRAY}· . · ·${NC}"
echo -e "${GRAY} . ·${NC}  ${CYAN}|___/  |_|  |___|  \\___|/_/ \\_\\|___/  \\___/  \\___/${NC}  ${GRAY}. · . ·${NC}"
echo -e "${GRAY} · .${NC}  ${CYAN}|___/  |_|  |___|  \\___|/_/ \\_\\|___/  \\___/  \\___/${NC}  ${GRAY}· . · ·${NC}"
echo -e "${GRAY} · . · . · . · . · . · . · . · . · . · . · . · . · . · . · . · . ·${NC}"
echo -e "${GRAY} . · . · . · . · . · . · . · . · . · . · . · . · . · . · . · . · .${NC}"
